...
phone: "+92 3182593455",
  ...
  "Optimizing context retrieval and memory management for efficient agent performance."
   ...
   { slug: "lead-forge", title: "LeadForge",
  tags: ["Next.js", "TypeScript", "Tailwind CSS", "FastAPI", "Embeddable Widget", "PostgreSQL", "Groq API"],
  desc: "AI-powered embeddable chat widget that qualifies website visitors and captures leads in real time.",
  image: "/img24.png", link: "https://lead-forge-peach.vercel.app/",
  longDescription: "LeadForge is a multi-tenant SaaS platform that lets any business embed an AI-powered chat widget on their website with a single script tag. Built on FastAPI and PostgreSQL, with Groq's LLM streaming responses over Server-Sent Events, the widget engages visitors in natural conversation, scores their intent automatically, and extracts contact details the moment they qualify — no static forms or manual follow-up required. A Next.js dashboard gives teams real-time visibility into every conversation and lead, while per-project domain whitelisting, JWT auth, and webhook integrations keep each organization's data isolated.",
  challenges: [ "The widget loaded fine locally but stayed invisible on real client sites — silently blocked by missing or mismatched CORS and Content-Security-Policy headers between the widget's origin and the host website's origin.",
